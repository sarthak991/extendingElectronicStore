 ...
 */
package com.extend.electronicstore.core.constants;

/**
 * Global class for all ExtendelectronicstoreCore constants. You can add global constants for your extension into this class.
 */
public final class ExtendelectronicstoreCoreConstants extends GeneratedExtendelectronicstoreCoreConstants
{
	public static final String EXTENSIONNAME = "extendelectronicstorecore";


	private ExtendelectronicstoreCoreConstants()
	{
		//empty
	}
