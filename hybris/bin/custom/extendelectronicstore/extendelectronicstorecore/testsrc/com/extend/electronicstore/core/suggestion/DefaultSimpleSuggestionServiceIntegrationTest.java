 ...
 */
package com.extend.electronicstore.core.suggestion;
...
import com.extend.electronicstore.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/extendelectronicstorecore/test/testSimpleSuggestionService.csv", "utf-8");
	}
