 ...
 */
package com.extend.electronicstore.test.setup;
...
import com.extend.electronicstore.test.constants.ExtendelectronicstoreTestConstants;
import com.extend.electronicstore.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ExtendelectronicstoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/extendelectronicstoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/extendelectronicstoretest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/extendelectronicstoretest/import/cstickets.impex");
			...
			importImpexFile(context, "/extendelectronicstoretest/import/csquotes.impex");
		}
	}
}
