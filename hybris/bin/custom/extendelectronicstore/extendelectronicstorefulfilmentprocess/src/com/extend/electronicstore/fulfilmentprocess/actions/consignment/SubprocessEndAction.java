 ...
 */
package com.extend.electronicstore.fulfilmentprocess.actions.consignment;
	...
	public void executeAction(final ConsignmentProcessModel process)
	{
		...
		getBusinessProcessService().triggerEvent(
				process.getParentProcess().getCode() + "_"
						+ ExtendelectronicstoreFulfilmentProcessConstants.CONSIGNMENT_SUBPROCESS_END_EVENT_NAME);
