 ...
 */
package com.extend.electronicstore.fulfilmentprocess.test.jobs;
...
import com.extend.electronicstore.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = ExtendelectronicstoreFulfilmentProcessConstants.ORDER_PROCESS_NAME;
