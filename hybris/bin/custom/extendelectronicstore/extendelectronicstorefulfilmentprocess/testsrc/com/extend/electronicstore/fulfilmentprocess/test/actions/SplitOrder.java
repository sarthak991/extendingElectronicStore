 ...
 */
package com.extend.electronicstore.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(ExtendelectronicstoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ExtendelectronicstoreFulfilmentProcessConstants.PARENT_PROCESS);
